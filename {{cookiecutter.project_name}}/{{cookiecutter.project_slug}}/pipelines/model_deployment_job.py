from {{cookiecutter.project_slug}}.common import Workload, MLflowTrackingConfig
from {{cookiecutter.project_slug}}.model_deployment import ModelDeployment, ModelDeploymentConfig
