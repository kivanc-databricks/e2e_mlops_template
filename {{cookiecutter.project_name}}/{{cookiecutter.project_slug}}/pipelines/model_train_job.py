from {{cookiecutter.project_slug}}.common import Workload, MLflowTrackingConfig, FeatureStoreTableConfig, LabelsTableConfig
from {{cookiecutter.project_slug}}.model_train import ModelTrain, ModelTrainConfig
