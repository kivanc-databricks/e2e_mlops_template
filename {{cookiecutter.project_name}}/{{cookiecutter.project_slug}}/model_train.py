...
from {{cookiecutter.project_slug}}.common import MLflowTrackingConfig, FeatureStoreTableConfig, LabelsTableConfig
from {{cookiecutter.project_slug}}.model_train_pipeline import ModelTrainPipeline
